...
* Handle message:
** After receiving the notification from your server, Ably processes and packages the notification with any additional data payload. This payload may include data such as message content, metadata, or any other relevant information needed for the notification.
...
** The selected push notification service (FCM, APNs, or Web Push) takes responsibility for delivering the notification to the target devices.
